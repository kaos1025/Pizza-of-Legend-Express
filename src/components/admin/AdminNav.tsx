...
import { ClipboardList, UtensilsCrossed, Truck, BarChart3, Bell, Clock } from 'lucide-react';
...
const tabs = [
  ...
  { href: '/admin/settings/business-hours', label: '영업시간', icon: Clock, exact: false, testId: 'admin-business-hours' },
  { href: '/admin/settings/notifications', label: '알림설정', icon: Bell, exact: false, testId: 'admin-notifications' },
];
